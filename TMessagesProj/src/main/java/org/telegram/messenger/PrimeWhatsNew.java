...
public final class PrimeWhatsNew {
    ...
    public static List<Entry> entries() {
        ...
        entries.add(new Entry("msg_channel", "Лента: рабочие комментарии, старт сверху",
                "Кнопка комментариев под постом теперь и правда открывает обсуждение. Лента больше не стартует снизу и не дёргает вас обратно при скролле вверх."));
        return entries;
    }
}
