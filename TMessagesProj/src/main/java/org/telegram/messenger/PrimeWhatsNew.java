...
public final class PrimeWhatsNew {
    ...
    public static List<Entry> entries() {
        ...
        entries.add(new Entry("msg_settings_old", "Плагины научились новому формату",
                "Система плагинов теперь понимает не только .plugin, но и .elyx — можно ставить оба формата, ничего дополнительно настраивать не нужно."));
        entries.add(new Entry("msg_folders", "Новый провайдер в «Музыке»", "Добавили YouTube Music — вход через браузер, без паролей и токенов вручную."));
        return entries;
    }
}
