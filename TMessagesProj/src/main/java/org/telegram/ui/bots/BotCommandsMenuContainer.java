...
public class BotCommandsMenuContainer extends FrameLayout implements NestedScrollingParent {
    ...
    public void setBackgroundDrawable(@NonNull BlurredBackgroundDrawable backgroundDrawable) {
        ...
        this.backgroundDrawable.setRadius(org.telegram.messenger.NonIslandHelper.chatElements() ? 0 : dp(22));
        this.backgroundDrawable.setPadding(org.telegram.messenger.NonIslandHelper.chatElements() ? 0 : dp(5));
