...
public class SimpleTextView extends View implements Drawable.Callback {
    ...
    // PrimeGram: a third right-side slot, alongside the emoji-status (rightDrawable) and
    // verified/scam/muted (rightDrawable2) slots those already occupy - for a badge that has to
    // sit next to both rather than replace either. Every method below that touches rightDrawable2
    // has a matching block for this one, in the same order, for the same reason.
    ...
    private boolean maybeClick, maybeClick3;
        ...
        if (layout.getLineCount() > 0) {
            ...
            if (rightDrawableInside) {
                ...
                if (rightDrawable3 != null && !rightDrawableOutside) {
                    rightDrawableWidth += (int) (rightDrawable3.getIntrinsicWidth() * rightDrawableScale);
                }
            }
...
//            textWidth = (int) Math.ceil(layout.getLineWidth(0));
    ...
    public int getTextWidth() {
        return textWidth + (rightDrawableInside ? (rightDrawable != null ? (int) (rightDrawable.getIntrinsicWidth() * rightDrawableScale) : 0) + (rightDrawable2 != null ? (int) (rightDrawable2.getIntrinsicWidth() * rightDrawableScale) : 0) + (rightDrawable3 != null ? (int) (rightDrawable3.getIntrinsicWidth() * rightDrawableScale) : 0) : 0);
    }
    ...
    public float getExactWidth() {
        return getPaint().measureText(getText().toString())
                ...
                - (leftDrawable != null || rightDrawable != null || rightDrawable2 != null || rightDrawable3 != null ? drawablePadding : 0);
    }
    ...
    public float getExactWidthIncludeDrawables() {
        return getExactWidth()
            ...
            + (rightDrawable3 != null ? rightDrawable3.getIntrinsicWidth() : 0);
    }
    ...
    public void invalidateDrawable(Drawable who) {
        ...
        } else if (who == rightDrawable3) {
            invalidate(rightDrawable3.getBounds());
