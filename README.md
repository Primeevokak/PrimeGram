...
**Расшифровка голосовых на устройстве.** Без Premium и без интернета. Текст появляется по мере
распознавания. Моделей пять — от быстрых и неточных до медленных и точных, выбираете сами.
