...
Одна вещь, которая удивляет всех, кто пришёл из exteraGram: **после установки плагин выключен**.
Включить его нужно вручную, переключателем в списке. Это сделано намеренно — код, который приехал
файлом из чата, не должен начинать работать сам по себе.
